							...
							<!-- Banner -->
									...
									<div class="features">
										<?php
														...
														$query1="select provider_emailid,first_name,last_name,middle_name,mobile_no,vlonteer,photo,service_id,service_name,provider_name,Specification,Built_date,service_table.country,service_table.state,service_table.city,service_table.address,service_table.Pincode,pic1,pic2,pic3 from service_table,user_table where user_table.email_id=service_table.provider_emailid and Register_as='Provider' and service_name=? order by service_id";
														...
														if($stmt1->num_rows>0)
														{
															$stmt1->bind_result($eid,$fname,$lname,$mname,$mno,$vlonteer,$photo,$sid,$sname,$pname,$spec,$bdate,$country,$state,$city,$address,$pcode,$pic1,$pic2,$pic3);
															 while($stmt1->fetch())
															 {
															 	echo '<article>';
